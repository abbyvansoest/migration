...
print('--- G_male ---')
print(len(G_male.nodes()))
print(len(G_male.edges()))
print('--- G_female ---')
print(len(G_female.nodes()))
print(len(G_female.edges()))
...
print('---- Male ----')
print(np.var(weights_male))
print(np.mean(weights_male))
...
print('---- Female ----')
print(np.var(weights_female))
print(np.mean(weights_female))
